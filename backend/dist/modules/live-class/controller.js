...
class Controller extends rootController_1.default {
    constructor() {
        ...
        this.getLiveClassesByStudent = this.catchAsync((req, res) => __awaiter(this, void 0, void 0, function* () {
            const studentId = req.params.studentId;
            const classes = yield service_1.LiveClassService.getLiveClassesByStudent(studentId);
            this.apiResponse(res, {
                statusCode: 200,
                success: true,
                message: "Live classes retrieved successfully!",
        ...
        this.updateStudentsAttendees = this.catchAsync((req, res) => __awaiter(this, void 0, void 0, function* () {
            const liveClassId = req.params.liveClassId;
            yield service_1.LiveClassService.updateStudentsAttendees(liveClassId, req.body);
            this.apiResponse(res, {
                statusCode: 200,
                success: true,
