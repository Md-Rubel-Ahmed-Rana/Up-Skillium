...
class Controller extends rootController_1.default {
    constructor() {
        ...
        this.getCoursesByCategory = this.catchAsync((req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const category = (_a = req.params) === null || _a === void 0 ? void 0 : _a.category;
            const courses = yield service_1.CourseService.getCoursesByCategory(category);
            this.apiResponse(res, {
                statusCode: 200,
                success: true,
        ...
        this.getStudentsFromCourse = this.catchAsync((req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const courseId = (_a = req.params) === null || _a === void 0 ? void 0 : _a.courseId;
            const students = yield service_1.CourseService.getStudentsFromCourse(courseId);
            this.apiResponse(res, {
                statusCode: 200,
                success: true,
        ...
        this.getMyStudentsByInstructor = this.catchAsync((req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const instructorId = (_a = req.params) === null || _a === void 0 ? void 0 : _a.instructorId;
